...
repo_name = "ofdma-spectrum-anomalies-simulation"
...
room_mesh, room_top_mesh = create_cuboid_mesh(
    room_anchor_point, room_size, "room", True
)
...
room_ceiling_object = bpy.data.objects.new("room_ceiling_object", room_top_mesh)
room_ceiling_object.data.materials.append(
    materials[scene_attributes["room"]["ceiling_material"]]
)
object_collection.append(room_ceiling_object)

# define obstacles
obstacle_counter = 0

if "obstacles" in scene_attributes:
